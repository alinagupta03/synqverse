  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass p-6 rounded-2xl border border-border space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="password" placeholder="••••••••" className="w-full bg-gray-100 border border-border rounded-xl p-3 text-foreground focus:outline-none focus:border-blue-500" />
          </div>
          <div>
          ...
          <div className="flex justify-end pt-2">
            <button className="bg-gray-200 hover:bg-gray-300 text-foreground px-6 py-2 rounded-xl font-medium transition-colors">Update Password</button>
          </div>
        </div>
      </div>
      ...
      <div className="glass p-6 rounded-2xl border border-border space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 border border-border rounded-xl bg-gray-100">
            <div>
              <p className="text-foreground font-medium">Windows • Chrome</p>
          ...
          <div className="flex items-center justify-between p-4 border border-border rounded-xl">
            <div>
              <p className="text-foreground font-medium">iOS • Safari</p>

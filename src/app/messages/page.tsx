    ...
    <div className="min-h-screen bg-gray-50 text-foreground flex flex-col">
      <header className="h-16 border-b border-gray-200 flex items-center px-6 justify-between glass sticky top-0 z-50">
        <div className="flex items-center gap-8">
           ...
           <nav className="hidden md:flex gap-6 text-sm">
             ...
             <Link href="/messages" className="text-gray-900 font-medium">Messages</Link>
           </nav>
        </div>
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full p-6 space-y-6">
        <div>
          ...
          <p className="text-gray-500">Your private conversations.</p>
        </div>
            ...
            {conversations.map(convo => {
              ...
              return (
                <Link href={`/messages/${convo.id}`} key={convo.id}>
                  <div className="p-4 glass rounded-2xl border border-gray-200 hover:border-gray-300 transition-all flex items-center gap-4 cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-900 truncate">{other?.user.anonymousId || "Anonymous Student"}</h3>
